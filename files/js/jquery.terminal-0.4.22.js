...
(function($, undefined) {
    ...
    */
    ...
    /**
     * Edited by me to support jquery-1.9
     *  > jQuery.browser was deprecated, now removed;
     * Old code:
        ...
        */
        ...
        $.extend(self, $.omap({
            ...
            signature: function(i) {
                var cols = self.cols();
                // Added option to select custom signature
                if (typeof(i) !== 'number') {
                    i = cols < 15 ? null : cols < 35 ? 0 : cols < 55 ? 1 : cols < 64 ? 2 : cols < 75 ? 3 : 4;
                }
                if (i !== null) {
